...
1.0.0 : classificateur aléatoire
1.1.0 : Régression logistique, entraînée sur la distance uniquement
1.2.0 : Régression logistique, entraînée sur l'angle uniquement
1.3.0 : Régression logistique, entraînée sur la distance et l'angle
...
Note pour lire les graphiques:
1.0.0 : classificateur aléatoire
1.1.0 : XGBoost, entraîné sur la distance uniquement
1.2.0 : XGBoost, entraîné sur l'angle uniquement
1.3.0 : XGBoost, entraîné sur la distance et l'angle
1.4.0 : XGBoost, entraîné sur nos caractéristiques trouvées en 4
1.5.0 : XGBoost, entraîné sur nos caractéristiques trouvées en 4 et avec des hyperparamètres optimisés
1.6.0 : XGBoost, entraîné sur nos caractéristiques trouvées en 4, avec des hyperparamètres optimisés et avec une sélection des caractéristiques
