...
À partir de ces 3 figures, nous avons pu réduire notre liste de caractéristiques à 7 caractéristiques: 'emptyNet', 'goal_distance', 'time_since_last',
'angle', 'y', 'shot_type', 'last_distance'. On remarque qu'on a inclut dans nos données une variable aléatoire qui nous permet de mettre de côté certaines caractéristiques négligeables.
